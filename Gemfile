...
gem 'aws-sdk-core', '~> 3.184.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
# Background jobs
gem 'sidekiq', '~> 7.1.4' # rubocop:todo Gemfile/MissingFeatureCategory
...
# Remote Development
gem 'devfile', '~> 0.0.22.pre.alpha1' # rubocop:todo Gemfile/MissingFeatureCategory
